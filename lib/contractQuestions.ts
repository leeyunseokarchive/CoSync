...
export const CONTRACT_QUESTIONS: ContractQuestion[] = [
  ...
  },
  {
    ...
    info: {
      what: "공동매도요구권(드래그얼롱)입니다. 인수자는 보통 지분 전부를 원하므로, 일부 주주가 팔지 않겠다고 하면 거래가 성립하지 않습니다. 이 조항은 정해진 비율 이상이 매각에 나서면 나머지도 같은 조건으로 따라 팔도록 요구할 수 있게 합니다. 제7조의 공동매도참여권(태그얼롱)이 소수 주주가 \"함께 팔 수 있는\" 권리라면, 이쪽은 다수 주주가 \"함께 팔라고 요구하는\" 권리입니다. 실무에서는 3분의 2 이상으로 두는 경우가 많습니다.",
