...
// lead: 대표이사인 주주. 계약서에서 "대표 주주"로 불리고, 제5조의 근속 의무와
// 지분 회수가 나머지와 다르게 적용된다(2차 변호사 자문).
export const MOCK_MEMBERS = [
  { id: "m1", name: "김민준", role: "나 (본인)", self: true, lead: true },
  { id: "m2", name: "이서연", role: "공동창업자", self: false, lead: false },
  { id: "m3", name: "박도윤", role: "공동창업자", self: false, lead: false },
];

/** 계약서에서 부르는 이름. 전문에서 정의하고 제5조가 이 이름으로 갈린다. */
export const partyLabel = (lead: boolean) => (lead ? "대표 주주" : "일반 주주");
...
export const CONTRACT_QUESTIONS: ContractQuestion[] = [
  {
    ...
    preview: {
      ...
      blocks: [
        ...
        { kind: "sign", text: "대표 주주   {0} ({1})          (인)" },
        { kind: "sign", text: "주소  {2}" },
        { kind: "sign", text: "일반 주주   이서연 (            )          (인)" },
        { kind: "sign", text: "주소" },
        { kind: "sign", text: "일반 주주   박도윤 (            )          (인)" },
        { kind: "sign", text: "주소" },
      ],
    },
    info: {
  ...
  },
  {
    ...
    preview: {
      ...
      blocks: [
        { kind: "para", text: "주주 [ ], [ ], [ ](이하 '주주들'이라 한다)은 회사의 설립 및 운영에 관하여 다음과 같이 합의한다. 이 중 대표이사인 주주를 '대표 주주', 그 외의 주주를 '일반 주주'라 한다." },
  ...
  },
  {
    ...
    info: {
      what: "전원 동의가 필요한 사항은 한 명이 반대하면 결정이 성립하지 않습니다. 이 조항은 그 상태가 무한히 이어지지 않도록, 정해진 협의 기간이 지나면 대표의 판단으로 결론을 내도록 합니다. 결정권자를 대표로 두는 것은 지분이 적은 주주가 최종 결정을 갖는 구조에서 분쟁이 생기기 때문입니다.",
  ...
  },
  {
    ...
    info: {
      ...
      low: "지분율에는 법이 정해 둔 문턱이 있습니다.\n· 66.7%를 넘으면 정관 변경·합병 같은 특별결의를 혼자 통과시킬 수 있습니다.\n· 50%를 넘으면 이사 선임·배당 같은 보통결의를 혼자 통과시킬 수 있습니다.\n· 33.4%를 넘으면 상대가 특별결의를 밀어붙이는 것을 막을 수 있습니다.\n· 3%를 넘으면 회계장부 열람이나 이사 해임 청구를 할 수 있습니다.\n각자의 비율이 어느 칸에 드는지 보면 결정 구조가 보입니다.",
  ...
  },
  {
    ...
    preview: {
      ...
      blocks: [
        { kind: "ellipsis" },
        { kind: "para", text: "② 제1항에도 불구하고 일반 주주가 3년 이내에 회사에서 퇴사하는 경우, 대표 주주는 퇴사하는 일반 주주가 보유하고 있는 주식 전부 또는 일부를 {0}로 매수할 수 있는 권리를 가진다." },
        { kind: "para", text: "③ 본 조에 의한 권리행사는 퇴사자가 다른 주주 및 회사에 대하여 부담하는 위약금 등 손해배상의무에 영향을 미치지 아니한다." },
        { kind: "ellipsis" },
    ...
    info: {
      what: "퇴사하는 일반 주주가 들고 나가는 주식을 대표 주주가 되살 수 있게 하는 조항입니다. 액면가는 주권에 적힌 액수로, 회사 가치가 오른 뒤에도 그대로입니다. 제9조 ③항은 계약을 중대하게 위반해 해지된 경우에도 액면가 양도를 정하고 있습니다.",
